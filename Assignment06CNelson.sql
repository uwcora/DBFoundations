...
-- 2023-02-21,CNelson,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_CNelson')
	 Begin 
	  Alter Database [Assignment06DB_CNelson] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_CNelson;
	 End
	Create Database Assignment06DB_CNelson;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_CNelson;
